...
impl Canvas {
    ...
    pub fn draw_sprite(&mut self, sprite: &Sprite) {
        for coords in &sprite.pixel_idxs {
            let x_idx = coords.0;
            let y_idx = coords.1;

            let x_target_in_canvas_float: f64 = sprite.origin.x + x_idx as f64;
            let y_target_in_canvas_float: f64 = sprite.origin.y + y_idx as f64;

            let x_target_in_canvas = x_target_in_canvas_float as u32;
            let y_target_in_canvas: u32 = y_target_in_canvas_float as u32;
